                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="location" class="form-control">
                                    ...
                                    <div class="wizard-header">
                                        ...
                                        <c:forEach items="${stations}" var="s" varStatus="vs" end="0">
                                            <a href="${pageContext.request.contextPath}/index/traininfo.do?id=${s.trainstate}">返回</a>
                                        </c:forEach>
                                        </h5>
                                    </div>
                                </div>
                                ...
                                <table border="0" class="form-control">
                                    ...
                                    <tr style="line-height: 200%">
                                        <td width="50px">${s.stationname}</td>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <td width="50px"><fmt:formatDate value="${s.arrivaltime}" type="time" timeStyle="short"/></td>
                                    </tr>
                                    </c:forEach>
                                </table>
