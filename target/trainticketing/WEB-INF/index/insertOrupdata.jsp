                ...
                <div class="wizard-container">
                    <div class="card wizard-card" data-color="green" id="wizard">
                        ...
                        <div class="tab-content">
                            ...
                            <form action="/passengerinfo/loginFileupload.do" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="${param.id}"><br />
                                姓名<input type="text" name="passengername" /><br />
                                身份证号<input type="text" name="idcard" /><br />
                                身份<input type="text" name="adult" list="adultlist" /><br />
                                <datalist id="adultlist">
                                    <option>成人</option>
                                    <option>儿童</option>
                                    <option>学生</option>
                                </datalist>
                                图片：<input type="file" name="headImage1" /><br />
