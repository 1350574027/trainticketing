                ...
                <div class="wizard-container">
                    <div class="card wizard-card" data-color="green" id="wizard">
                        ...
                        <div class="tab-content">
                            ...
                            <form action="/admin/insertTraininfo.do" method="post">
                                <input type="hidden" name="id" value="${param.id}"><br />
                                列车号<input type="text" name="trainid" /><br />
                                车厢数<input type="text" name="carriagenumber" /><br />
                                车厢载客数<input type="text" name="carriagenumpeo" /><br />
